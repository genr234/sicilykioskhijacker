  ...
  function (a) {
    ...
    if ("undefined" != typeof a || "undefined" != typeof a.document) {
      var b,
        ...
        k = { All: "all", Keyboard: "keyboard", Numpad: "numpad" },
        l = { Bottom: "bottom", Top: "top" },
        m = function () {
          var a = {},
            b = !1,
            c = 0;
        ...
        n = function (a) {
          if (Array.isArray(a) && 0 < a.length) {
            ...
            if ("object" == typeof b && !Array.isArray(b))
              for (var c in b)
                if (Object.prototype.hasOwnProperty.call(b, c)) return !0;
          }
          return !1;
        },
        o = function (a) {
      ...
      (function () {
        ...
        return (
          ...
          void ((b.prototype = a.Event.prototype), (a.Event = b))
        );
      })();
      var u = function (a, b) {
          ...
          if (c && 0 < c.length)
            for (var d, e = 0; e < c.length; e++)
              if (((d = c[e]), a.target === d)) return !0;
          return !1;
        },
        v = {
          init: function (a) {
            (a = "object" == typeof a && 0 < Object.keys(a).length ? a : {}),
              (c = m(!0, f, a)),
              e();
          },
          run: function (d, e) {
            var w = [],
              ...
              y =
                -1 <
                x.indexOf(((d || {}).nodeName || "").toLocaleLowerCase("en"));
            if (y) w.push(d);
            else {
              var z = "string" == typeof d && 0 < d.length;
              if (!z) return o('"' + d + '" is not a valid selector.'), !1;
              if (((w = a.document.querySelectorAll(d)), 1 > w.length))
                return (
                  o(
            ...
            var A = c,
              B = A.keysArrayOfObjects,
              C = !1;
            if ((n(B) && ((C = !0), (b = B)), !C)) {
              var D =
                "string" == typeof A.keysJsonUrl && 0 < A.keysJsonUrl.length;
              if (!D)
                return (
                  o(
            ...
            for (
              var E = function (b, c) {
                  var d = [c],
                    f = null !== c.getAttribute("readonly"),
                    g = !0 === A.allowMobileKeyboard,
                    m = function (c) {
                      var f = c.currentTarget,
                        m = 0,
                        n = [],
                        o = [k.All, k.Keyboard, k.Numpad],
                        p = (f.dataset.kioskboardType || "").toLocaleLowerCase(
                          "en"
                        ),
                        v = -1 < o.indexOf(p) ? p : k.All,
                        w = (
                          f.dataset.kioskboardPlacement || ""
                        ).toLocaleLowerCase("en"),
                        x = w === l.Top ? w : l.Bottom,
                        y =
                          "true" ===
                          (
                            f.dataset.kioskboardSpecialcharacters || ""
                          ).toLocaleLowerCase("en"),
                        z =
                          "string" == typeof A.language && 0 < A.language.length
                            ? A.language.toLocaleLowerCase("en")
                            : "en";
                      g || (f.setAttribute("readonly", "readonly"), f.blur());
                      var B = (f.value || "").length;
                      (m = f.selectionStart || B), (n = f.value.split(""));
                      var C = "",
                        D =
                          "string" == typeof A.keysFontFamily &&
                          0 < A.keysFontFamily.length
                            ? A.keysFontFamily
                            : "sans-serif",
                        E =
                          "string" == typeof A.keysFontSize &&
                          0 < A.keysFontSize.length
                            ? A.keysFontSize
                            : "22px",
                        F =
                          "string" == typeof A.keysFontWeight &&
                          0 < A.keysFontWeight.length
                            ? A.keysFontWeight
                            : "normal",
                        G = !0 === A.capsLockActive,
                        H =
                          "string" == typeof A.keysIconSize &&
                          0 < A.keysIconSize.length
                            ? A.keysIconSize
                            : "25px",
                        I = !0 === A.keysAllowSpacebar,
                        J = I ? " " : "",
                        K =
                          "string" == typeof A.keysSpacebarText &&
                          0 < A.keysSpacebarText.length
                            ? A.keysSpacebarText
                            : "Space",
                        L =
                          "string" == typeof A.keysEnterText &&
                          0 < A.keysEnterText.length
                            ? A.keysEnterText
                            : "Enter",
                        M =
                          ...
                          (I ? "spacebar-allowed" : "spacebar-denied") +
                          '" data-value="' +
                          J +
                          '">' +
                          K +
                      ...
                      if (y) {
                        ...
                        Q =
                          ...
                          s(2 * S + "px", S + "px", "#707070") +
                          "</span>";
                        var T = A.keysSpecialCharsArrayOfStrings;
                        for (var U in (Array.isArray(T) &&
                          0 < T.length &&
                          (h = T.reduce(function (a, b, c) {
                            return (a[c] = b), a;
                          }, {})),
                        h))
                      ...
                      if (v === k.Numpad) {
                        var X = A.keysNumpadArrayOfNumbers;
                        Array.isArray(X) &&
                          10 === X.length &&
                          (i = X.reduce(function (a, b, c) {
                            return (a[c] = b), a;
                          }, {}));
                        var Y = "";
                        for (var Z in i)
                      ...
                      if (v === k.Keyboard || v === k.All) {
                        if (v === k.All) {
                          var ba = "";
                          for (var ca in j)
                            if (Object.prototype.hasOwnProperty.call(j, ca)) {
                              var da = j[ca],
                                ea =
                                  '<span style="font-family:' +
                                  D +
                        ...
                        for (var fa = 0; fa < b.length; fa++) {
                          var e = b[fa],
                            ga = "";
                          for (var ha in e)
                            if (Object.prototype.hasOwnProperty.call(e, ha)) {
                              var ia = e[ha],
                                ja =
                                  '<span style="font-family:' +
                                  D +
                                  ...
                                  E +
                                  ';" class="kioskboard-key kioskboard-key-' +
                                  ia.toString().toLocaleLowerCase(z) +
                                  '" data-index="' +
                                  ha.toString() +
                                  '" data-value="' +
                                  ia.toString() +
                        ...
                        if (
                          ((C +=
                            ...
                            (y ? "kioskboard-with-specialcharacter" : "") +
                            '">' +
                            N +
                            Q +
                            M +
                      ...
                      var ma = (function (b) {
                          ...
                          return (
                            (c.className = "kioskboard-wrapper"),
                            (c.innerHTML = b.trim()),
                            c
                          );
                        })(C),
                        na = !0 === A.cssAnimations,
                        oa = "no-animation",
                        pa = "no-animation",
                        qa = 0;
                      na &&
                        ((oa = "kioskboard-with-animation"),
                        (pa = "kioskboard-fade"),
                        (qa =
                          "number" == typeof A.cssAnimationsDuration
                            ? A.cssAnimationsDuration
                            : 360),
                        "slide" === A.cssAnimationsStyle &&
                          (pa = "kioskboard-slide"));
                      var ra =
                          "string" == typeof A.theme && 0 < A.theme.length
                            ? A.theme.trim()
                            : "light",
                        sa = a.document.createElement("div");
                      (sa.id = "KioskBoard-VirtualKeyboard"),
                        sa.classList.add("kioskboard-theme-" + ra),
                        sa.classList.add("kioskboard-placement-" + x),
                        sa.classList.add(oa),
                        sa.classList.add(pa),
                        sa.classList.add(
                          G
                        ...
                        (sa.lang = z),
                        (sa.style.webkitLocale = '"' + z + '"'),
                        (sa.style.animationDuration = na ? qa + "ms" : ""),
                        sa.appendChild(ma);
                      var ta = function () {
                      ...
                      f.addEventListener(
                        "keypress",
                        function (a) {
                          var b = !0 === A.allowRealKeyboard;
                          return b
                            ? void (n = a.currentTarget.value.split(""))
                            : (a.stopPropagation(),
                              a.preventDefault(),
                              (a.returnValue = !1),
                              (a.cancelBubble = !0),
                      ...
                      var va = function (b, c) {
                        ...
                        wa = function (b) {
                          var c =
                            a.document.querySelectorAll(".kioskboard-key");
                          if (c && 0 < c.length)
                            for (var d, e = 0; e < c.length; e++)
                              (d = c[e]),
                                va(d, function (a) {
                                  ...
                                  f = G
                                    ? f.toLocaleUpperCase(z)
                                    : f.toLocaleLowerCase(z);
                                  for (
                                    var g = f.split(""), h = 0;
                                    h < g.length;
                                    h++
                                    ...
                                    (m =
                                      ...
                                      (b.value = n.join("")),
                                      "number" !== b.type &&
                                        b.setSelectionRange(m + 1, m + 1),
                                      b.dispatchEvent(ua);
                                });
                          var f = a.document.querySelector(
                          ...
                          f &&
                            va(f, function (a) {
                              a.preventDefault(),
                                b.focus(),
                                a.currentTarget.classList.contains(
                                  "capslock-active"
                                )
                                  ? (a.currentTarget.classList.remove(
                                      "capslock-active"
                                    ),
                                    sa.classList.add("kioskboard-tolowercase"),
                                    sa.classList.remove(
                                      "kioskboard-touppercase"
                                    ),
                                    (G = !1))
                                  : (a.currentTarget.classList.add(
                                    ...
                                    sa.classList.add("kioskboard-touppercase"),
                                    (G = !0));
                            });
                          var g = a.document.querySelector(
                          ...
                          var h = a.document.querySelector(
                              ".kioskboard-key-specialcharacter"
                            ),
                            i = a.document.querySelector(
                          ...
                          var j = a.document.querySelector(
                          ...
                          j &&
                            ...
                            va(j, function (a) {
                              a.preventDefault(),
                                b.focus(),
                                h.classList.remove("specialcharacter-active"),
                                i.classList.remove(
                                  "kioskboard-specialcharacter-show"
                                );
                            });
                          var k = a.document.querySelector(
                            ".kioskboard-key-enter"
                          );
                          k &&
                            va(k, function () {
                              !0 === A.keysEnterCanClose && ta(),
                                "function" == typeof A.keysEnterCallback &&
                                  A.keysEnterCallback();
                            });
                        },
                        xa = a.document.getElementById(
                          "KioskBoard-VirtualKeyboard"
                        );
                      if (!xa) {
                        a.document.body.appendChild(sa);
                        var ya = Math.round(a.innerHeight),
                          za = Math.round(a.document.body.clientHeight),
                          Aa = Math.round(
                            a.document.getElementById(
                              "KioskBoard-VirtualKeyboard"
                            ).offsetHeight
                          );
                        if (Aa > Math.round(2 * (ya / 3))) {
                          var Ba = a.document.querySelector(
                            ".kioskboard-wrapper"
                          );
                          (Ba.style.maxHeight =
                            Math.round(4 * (ya / 5)) + "px"),
                            (Ba.style.overflowX = "hidden"),
                            (Ba.style.overflowY = "auto"),
                            Ba.classList.add("kioskboard-overflow");
                        }
                        var Ca = x === l.Top,
                          Da =
                            (Ca
                              ? f.getBoundingClientRect().top
                              : f.getBoundingClientRect().bottom) || 0,
                          Ea = a.document.documentElement.scrollTop || 0,
                          Fa = Math.round(Da + Ea),
                          Ga = Fa < Aa && Ca;
                        if (Ga || (za <= Fa + Aa && !Ca)) {
                          var Ha = a.document.getElementById(
                          ...
                          var Ia =
                              ...
                              Aa +
                              "px !important;}</style>",
                            Ja = a.document.createRange();
                          Ja.selectNode(a.document.head);
                          var Ka = Ja.createContextualFragment(Ia);
                          a.document.head.appendChild(Ka),
                            a.document.body.classList.add(
                              "kioskboard-body-padding"
                            );
                        }
                        var La = !0 === A.autoScroll;
                        if (La) {
                          var Ma = Ca ? 20 : 50,
                            Na = f.getBoundingClientRect().top || 0,
                            Oa = Math.round(Na + Ea),
                            Pa = !0 === A.cssAnimations ? "smooth" : "auto",
                            Qa =
                              !0 === A.cssAnimations &&
                              "number" == typeof A.cssAnimationsDuration
                                ? A.cssAnimationsDuration
                                : 0,
                            Ra = Oa - Ma - (Ca ? Aa : 0),
                            Sa = a.navigator.userAgent.toLocaleLowerCase("en"),
                            Ta = -1 < Sa.indexOf(".net4"),
                            Ua = -1 < Sa.indexOf("edge"),
                            Va = Ua && -1 < Sa.indexOf("webview");
                          if ((!Ua || Va) && !Ta)
                            var Wa = setTimeout(function () {
                              Va
                                ? a.scrollBy(0, Oa)
                                : a.scrollTo({
                                    top: Ra,
                          ...
                          else a.document.documentElement.scrollTop = Ra;
                        }
                        wa(f);
                        var Xa = function (b) {
                          var c = setTimeout(function () {
                            var e = a.document.getElementById(
                              "KioskBoard-VirtualKeyboard"
                            );
                            if (
                              (!e ||
                        ...
                        a.document.addEventListener("click", Xa);
                      }
                    };
                  c.addEventListener("focus", m);
                  c.addEventListener("focusout", function (a) {
                    g || f || a.currentTarget.removeAttribute("readonly");
                  });
                },
                F = function (a, c) {
                  if (!b) {
              ...
              var H = w[G],
                I = ((H || {}).tagName || "").toLocaleLowerCase("en");
              -1 < x.indexOf(I)
                ? b
                  ? E(b, H)
                  : F(A.keysJsonUrl, H)
